...
aplicativos=($anki_apt_app $telegram_apt_app $nodejs_apt_app $neovim_apt_app $powerline_apt_app $tilix_apt_app $tmux_apt_app $terminal_programas_apt_app $logitech_mouse_driver_apt_app) 
